/* ================================================================
   ...
   - 카드별 테두리 모양을 나눠 그린다:
     ...
     데스크탑/세로모바일/태블릿은 기존 규칙(안과만 OCL, 나머지 FULL) 그대로 유지.
